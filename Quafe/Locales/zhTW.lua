...
LOCALE['CUSTOM_LAYOUT'] = '自訂界面配置' --v64
...
LOCALE['SHOW_HEAD_SLOT'] = '頭像顯示頭部裝備'
LOCALE['SHOW_SHOULDER_SLOT'] = '頭像顯示肩甲'
LOCALE['SHOW_CHEST_SLOT'] = '頭像顯示胸甲'
LOCALE['SHOW_WAIST_SLOT'] = '頭像顯示腰帶'
