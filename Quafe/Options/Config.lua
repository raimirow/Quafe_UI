...
function F.CreateJoystick(frame, sizeX,sizeY, framename)
	local Mover = CreateFrame("Frame", nil, Quafe_ConfigMover, "BackdropTemplate")
	...
	for k, v in ipairs(DB.DropMenu) do
		if v then
			if not frame.Menu[k] then
				frame.Menu[k] = CreateFrame("Button", nil, frame, "BackdropTemplate")
...
local Button_Artwork = function(frame, style, hasbutton)
	local Plus = CreateFrame("Button", nil, frame, "BackdropTemplate")
...
local function Aurawatch_Bar_Artwork(frame, scroll)
	local Sn = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local SnUp = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local SnDown = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local StyleButton = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local AuraButton = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local AuraIndicator = CreateFrame("Frame", nil, AuraButton, "BackdropTemplate")
	...
	local SpellButton = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local SpellIndicator = CreateFrame("Frame", nil, SpellButton, "BackdropTemplate")
	...
	local MenuButton = CreateFrame("Button", nil, frame, "BackdropTemplate")
...
local function Aurawatch_Title_Template(frame)
	...
	Bar.Plus = CreateFrame("Button", nil, Bar, "BackdropTemplate")
...
local function AddNew_Dropdown_Color_Create(frame, button, DB)
	local Icon = CreateFrame("Frame", nil, button, "BackdropTemplate")
	...
	for k, v in ipairs(DB) do
		if v then
			...
			frame.Menu[k].Icon = CreateFrame("Frame", nil, frame.Menu[k], "BackdropTemplate")
...
local function IconButton_Frame(frame, pos)
	...
	local IconSelect = CreateFrame("Frame", nil, frame, "BackdropTemplate")
	...
	for k, v in ipairs(C.WatcherIcon) do
		IconMatrix[k] = CreateFrame("Button", nil, IconHold, "BackdropTemplate")
...
local function Aurawatch_AddNew_Buttons(frame)
	...
	local TypeButton = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local AuraColor = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local AuraUnit = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local AuraCaster = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local SpellColor = CreateFrame("Button", nil, frame, "BackdropTemplate")
...
local function UDF_ColorPick_Buttons(frame)
	...
	local Color1 = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local Color2 = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local Color3 = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local Color4 = CreateFrame("Button", nil, frame, "BackdropTemplate")
...
local function Hotkey_Create(frame, scroll, configframe)
	...
	local Primary = CreateFrame("Button", nil, frame, "BackdropTemplate")
	...
	local Alternate = CreateFrame("Button", nil, frame, "BackdropTemplate")
...
local function Profile_Title_Template(frame)
	...
	local Plus = CreateFrame("Button", nil, Bar, "BackdropTemplate")
	Plus: SetSize(button_size,button_size)
...
local function ProfileBar_Template(frame)
	...
	local TickButton = CreateFrame("Button", nil, Bar, "BackdropTemplate")
	...
	local MenuButton = CreateFrame("Button", nil, Bar, "BackdropTemplate")
	MenuButton: SetSize(button_size, button_size)
	...
	local NameHold = CreateFrame("Button", nil, Bar, "BackdropTemplate")
	...
	local DeleteButton = CreateFrame("Button", nil, EditHold, "BackdropTemplate")
	...
	local CopyButton = CreateFrame("Button", nil, EditHold, "BackdropTemplate")
	...
	local ReNameButton = CreateFrame("Button", nil, EditHold, "BackdropTemplate")
	...
	local CancelButton = CreateFrame("Button", nil, ReNameHold, "BackdropTemplate")
	...
	local ConfirmButton = CreateFrame("Button", nil, ReNameHold, "BackdropTemplate")
...
local function Notice_Reload(frame)
	local nReload = CreateFrame("Button", nil, frame, "BackdropTemplate")
...
Quafe_Config: SetClampedToScreen(true)
Quafe_Config: SetMovable(true)
...
local function Quafe_Config_Load()
	...
	Quafe_Config: EnableMouse(true)
	Quafe_Config: RegisterForDrag("LeftButton","RightButton")
	Quafe_Config: SetScript("OnDragStart", function(self) self:StartMoving() end)
	Quafe_Config: SetScript("OnDragStop", function(self) self:StopMovingOrSizing() end)
